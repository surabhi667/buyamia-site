    ...
    <>
      <main className="account-page shell">
        ...
        <aside className="account-side">
          ...
          {['Account', 'Security', 'Shipping Address', 'Bank Account', 'Order', 'Wishlist', 'Browsing History', 'Affiliate'].map((item) => <button type="button" key={item} onClick={item === 'Shipping Address' ? () => { window.location.href = '/account/shipping-addresses' } : item === 'Security' ? () => { window.location.href = '/account/security' } : item === 'Bank Account' ? () => { window.location.href = '/account/bank-accounts' } : item === 'Order' ? () => { window.location.href = '/account/orders' } : item === 'Wishlist' ? () => { window.location.href = '/account/wishlist' } : item === 'Browsing History' ? () => { window.location.href = '/account/history' } : item === 'Affiliate' ? () => { window.location.href = '/account/affiliate' } : undefined}>{item}<span>›</span></button>)}
        </aside>
      </main>
